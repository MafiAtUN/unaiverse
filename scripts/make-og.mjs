...
body{width:1200px;height:630px;background:#070B1A;font-family:'IN';color:#F5F1E6;overflow:hidden;position:relative}
.sky{position:absolute;inset:0;
  background:
    radial-gradient(ellipse 70% 55% at 50% -8%, rgba(0,158,219,.20), transparent 70%),
    radial-gradient(ellipse 50% 40% at 88% 85%, rgba(201,162,39,.13), transparent 70%);}
.stars{position:absolute;inset:0;background-image:
  radial-gradient(1.6px 1.6px at 12% 18%, rgba(245,241,230,.8), transparent),
  radial-gradient(1.4px 1.4px at 68% 9%, rgba(0,158,219,.7), transparent),
  ...
  radial-gradient(1.5px 1.5px at 51% 84%, rgba(201,162,39,.6), transparent),
  ...
  radial-gradient(1.2px 1.2px at 24% 35%, rgba(0,158,219,.5), transparent),
...
.kicker{font-family:'PX';font-size:19px;letter-spacing:.24em;text-transform:uppercase;color:#C9A227;margin-bottom:26px}
h1{font-family:'SG';font-size:128px;font-weight:700;letter-spacing:-.035em;line-height:1;
  background:linear-gradient(102deg,#F5F1E6 18%,#009EDB 88%);-webkit-background-clip:text;background-clip:text;color:transparent}
...
.s dd{font-family:'PX';font-size:36px;color:#F5F1E6}
...
.olive{position:absolute;right:-90px;top:-70px;width:520px;height:520px;
  border:2px solid rgba(201,162,39,.22);border-radius:50%}
.olive2{position:absolute;right:-40px;top:-20px;width:420px;height:420px;
  border:1px solid rgba(0,158,219,.18);border-radius:50%}
</style></head><body>
